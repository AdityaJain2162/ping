package com.adityajain.geonote.ui.components
...
import com.adityajain.geonote.util.AdConfig
...
/**
 * Material 3-aware AdMob banner. Shown only on HomeScreen (per AGENTS.md).
...
fun BannerAd(modifier: Modifier = Modifier) {
    ...
    // Configure test device once so requests return test ads in debug.
    remember {
